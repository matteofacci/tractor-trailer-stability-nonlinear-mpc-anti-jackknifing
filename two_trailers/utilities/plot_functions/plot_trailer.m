function plot_trailer(xR,yR,hitchJoint,theta,psi,trailerWidth,trailerLenght,trailerBodyLenght,trailerRGB,wheelWidth,wheelDiam,wheelRGB,hitchJoint2,plotArrow,opacity)
...
if hitchJoint2
    p3 = plot([xR,hitchJoint2(1)],[yR,hitchJoint2(2)],'Color',wheelRGB, 'LineWidth',1.5);
    p3.Color(4) = 0.3;  % 70% transparent
    %scatter(hitchJoint(1),hitchJoint(2),30,'filled','MarkerEdgeColor',wheelRGB);
    r = wheelWidth/2;
    c1 = wheelRGB;
    c2 = "b";
    circles = plotFilledCircle(hitchJoint2(1),hitchJoint2(2),r,c1,c2);
end
