...
L = 0.255; L1 = 0.068; L2 = 0.262; d = 0.1; %tractorBodyLenght*0.5; % vehicle parameters

tractor_rad = sqrt(tractorBodyLenght^2 + tractorWidth^2) / 2;
trailer_rad = sqrt(trailerBodyLenght^2 + trailerWidth^2) / 2;
...
states = [x;y;theta;psi;phi]; % vector of all states
