function [x_final, y_final, theta_final, psi_final, phi_final, x_dot_final, y_dot_final,v,omega] = auxiliaryTrajectory_offline(current_time,total_time,x0,motion,model,trajectory,n_s,K1,K2)
