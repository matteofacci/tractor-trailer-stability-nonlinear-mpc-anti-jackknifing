function [x_final,y_final,theta_final,psi_final,phi_final,x_dot_final,y_dot_final] = auxiliaryTrajectory_online(motion,model,x0,t_aux,x_aux,y_aux,n_s,K1,K2)
